...
export const paymentRecordsRelations = relations(paymentRecords, ({ one }) => ({
  business: one(business, { fields: [paymentRecords.businessId], references: [business.id] }),
  subscription: one(businessSubscriptions, { fields: [paymentRecords.subscriptionId], references: [businessSubscriptions.id] }),
  plan: one(plans, { fields: [paymentRecords.planId], references: [plans.id] }),
}));
